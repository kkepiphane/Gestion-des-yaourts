...
if (isset($_POST['btnAddIng'])) {
    ...
    $date = date('Y:m:d');
         $ingrediant->addIngrediant($_POST['nomIng'], $_POST['prixU'], $_POST['quantiteIng'],$nomUser,$date);
...
$ingrediant->updateIngrediant($idUp, $_POST['nomIng'], $_POST['prixU'], $_POST['quantiteIng']);
}
