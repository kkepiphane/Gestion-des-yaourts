            ...
            <div class="row">
              ...
              <div class="col-xs-6 col-sm-6">
                <div class="form-group ">
                  ...
                  <div class="col-lg-8">
                    <input class=" form-control" id="cname" name="telLivreur" minlength="2" type="text" required />
                  </div>
                </div>
              </div>
            </div>
          ...
          <tbody>
            <?php foreach ($daLiv as $echoLiv) :; ?>
              <tr>
                ...
                <td>
                  <a href="upLivreur.php?id_liv=<?= $echoLiv->idLivreur; ?>" onclick="return confirm('Êtes-vous sûr de vouloir modifier les informations du Livreur : <?= $echoLiv->nom_dis; ?>')" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                  <a href="../controller/controllerLivreur.php?id_dLiv=<?= $echoLiv->idLivreur; ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer le livreur : <?= $echoLiv->nom_dis; ?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
