                ...
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="upYaourt.php?idUpYa=<?=$lireYaoutUps->id_yaourt;?>">
                        ...
                        <div class="col-xs-6 col-sm-6">
                            ...
                            <label for="cname" class="control-label col-lg-2">Type d'ingrédiant</label>
                                ...
                                <select class="form-control" name="typeIng">
                                    <option value="<?=$lireYaoutUps->id_ing;?>"><?=$lireYaoutUps->nom_ing;?></option>
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-1 col-lg-8">
                      <button class="btn btn-theme" type="submit" name="btnUpYa">Modifier</button>
                      <a href="listeYaourts.php" class="btn btn-theme04" type="reset">Cancel</a>
                    </div>
                  </div>
                </form>
              </div>
